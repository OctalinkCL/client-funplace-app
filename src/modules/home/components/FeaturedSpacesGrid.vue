<template>
  ...
  <div v-if="loading" class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div v-for="n in 3" :key="n" class="rounded-xl border bg-neutral-100 animate-pulse aspect-4/3" />
  </div>

  <!-- Espacios reales -->
  <div v-else-if="spaces.length" class="grid grid-cols-1 md:grid-cols-3 gap-6">
